 ...
 * Firebase/API requests are always passed through to the network.
 */

const CACHE_VERSION = 'doni-v3.0.0';
const APP_SHELL = [
    './',
    './index.html',
    './projects.html',
...
self.addEventListener('fetch', (event) => {
    ...
    // App shell / same-origin: cache-first with background refresh.
    event.respondWith(
